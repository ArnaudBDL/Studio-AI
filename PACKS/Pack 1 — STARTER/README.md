...
Ce pack transforme le quickstart gratuit en methode complete et reutilisable.
...
A la fin du pack, tu dois savoir:

- ecrire un prompt coherent sans surcharger
- iterer proprement sur une base stable
- reconnaitre ce qui manque quand une generation derape

## Ce que ce pack ne couvre pas

- templates projet complets
- systeme d'iteration documente version par version
