...
Ce pack introduit un process de studio reproductible.

## Contenu

- 00_DOCS: documents de reference et regles internes.
- 01_PROJECT_TEMPLATE: template de projet a dupliquer par track.
