# BandLab SongStarter - Guide CREATOR
...
1. Prompt master versionne (v01).
2. Variante A/B sur une hypothese unique.
3. Log symptome, hypothese, correction.
4. Garder la variante gagnante.
